...
{
    public class LaserHitParticle : Particle
    {
        ...
        public static void CreateLaserHitParticle(Vector3 pos)
        {
            ParticleManager.Instance.Add(new LaserHitParticle(pos));
        }
        public LaserHitParticle(Vector3 Position)
            : base()
        {
