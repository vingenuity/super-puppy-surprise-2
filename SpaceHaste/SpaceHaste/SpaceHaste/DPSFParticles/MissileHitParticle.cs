...
{
    public class MissileHitParticle : Particle
    {
        ...
        public static void CreateMissileHitParticle(Vector3 pos)
        {
            ParticleManager.Instance.Add(new MissileHitParticle(pos));
        }
        public MissileHitParticle(Vector3 Position)
            : base()
        {
