...
namespace DPSF.ParticleSystems
{
	...
	class AnimatedSpriteParticleSystem : DefaultAnimatedSpriteParticleSystem
	{
		...
		protected override void InitializeRenderProperties()
		{
			...
			SpriteBatchSettings.SortMode = SpriteSortMode.Immediate;	// Must use Immediate mode in order for our Effect and the SortParticleByDepth particle system event to apply

			// Use DepthRead to eliminate nasty black box artifacts
