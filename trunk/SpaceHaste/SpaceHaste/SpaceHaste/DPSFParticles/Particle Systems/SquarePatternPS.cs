...
namespace DPSF.ParticleSystems
{
	...
	[Serializable]
#endif
	class SquarePatternParticleSystem : DefaultTexturedQuadParticleSystem
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public void InitializeParticleSquarePattern(DefaultTexturedQuadParticle cParticle)
		{
		...
		public void InitializeParticleChangeColor(DefaultTexturedQuadParticle cParticle)
		{
		...
		protected void UpdateParticleChangeParticleColor(DefaultTexturedQuadParticle cParticle, float fElapsedTimeInSeconds)
		{
			// Assign this Particle a new Random Color
			cParticle.Color = DPSFHelper.RandomColor();
		}

		protected void UpdateParticleChangeDirection1(DefaultTexturedQuadParticle cParticle, float fElapsedTimeInSeconds)
		{
			// Move Up
			cParticle.Velocity = new Vector3(0, 50, 0);
		}

		protected void UpdateParticleChangeDirection2(DefaultTexturedQuadParticle cParticle, float fElapsedTimeInSeconds)
		{
			// Move Left
			cParticle.Velocity = new Vector3(-50, 0, 0);
		}

		protected void UpdateParticleChangeDirection3(DefaultTexturedQuadParticle cParticle, float fElapsedTimeInSeconds)
		{
			// Move Down
			cParticle.Velocity = new Vector3(0, -50, 0);
		}

		protected void UpdateParticleChangeColor1(DefaultTexturedQuadParticle cParticle, float fElapsedTimeInSeconds)
		{
			cParticle.Color = Color.Green;
		}

		protected void UpdateParticleChangeColor2(DefaultTexturedQuadParticle cParticle, float fElapsedTimeInSeconds)
		{
			cParticle.Color = Color.Yellow;
		}

		protected void UpdateParticleChangeColor3(DefaultTexturedQuadParticle cParticle, float fElapsedTimeInSeconds)
		{
