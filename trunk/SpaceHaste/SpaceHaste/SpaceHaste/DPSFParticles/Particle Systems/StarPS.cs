...
namespace DPSF.ParticleSystems
{
	...
	[Serializable]
#endif
	class StarParticleSystem : DefaultTexturedQuadParticleSystem
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public void InitializeParticleStar2D(DefaultTexturedQuadParticle cParticle)
		{
			InitializeParticleUsingInitialProperties(cParticle);

			// Add 7 more Particles, going in different 2D directions
			DefaultTexturedQuadParticle cParticle2 = new DefaultTexturedQuadParticle();
			DefaultTexturedQuadParticle cParticle3 = new DefaultTexturedQuadParticle();
			DefaultTexturedQuadParticle cParticle4 = new DefaultTexturedQuadParticle();
			DefaultTexturedQuadParticle cParticle5 = new DefaultTexturedQuadParticle();
			DefaultTexturedQuadParticle cParticle6 = new DefaultTexturedQuadParticle();
			DefaultTexturedQuadParticle cParticle7 = new DefaultTexturedQuadParticle();
			DefaultTexturedQuadParticle cParticle8 = new DefaultTexturedQuadParticle();
		...
		public void InitializeParticleStar3D(DefaultTexturedQuadParticle cParticle)
		{
