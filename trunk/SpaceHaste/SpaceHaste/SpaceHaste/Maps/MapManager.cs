...
namespace SpaceHaste.Maps
{
    public class MapManager : GameComponent
    {
            ...
            : base(game)
        {
            ...
            if (currentAct == 1 && currentScene == 3) { Map = new Map_Act1Scene3(); }
            if (currentAct == 2 && currentScene == 1) { Map = new Map_Act2Scene1(); }
            if (currentAct == 2 && currentScene == 2) { Map = new Map_Act2Scene2(); }
            ...
            if (currentAct == 3 && currentScene == 3) { Map = new Map_Act3Scene3(); }
